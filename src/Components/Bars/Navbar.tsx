    ...
    return (
        <header>
            <div id="sticky-header" className="menu-area transparent-header">
                                                ...
                                                <ul className="list-wrap">
                                                    <li>
                                                        ...
                                                        <div className="content">
                                                            <a href="tasrif.official@gmail.com">tasrif.official@gmail.com</a>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div className="icon">
                                                        ...
                                                        <div className="content">
                                                            <span>Maijdee Court, Noakhali, Bangladesh</span>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div className="icon">
                                ...
                                <div className="customer-support-wrap">
                                    ...
                                    <div className="customer-support-content">
                                        ...
                                        <p>We offer solutions for businesses of all sizes. For questions about our plans and
                                            products,,
                                            contact our team of experts. <a href="/contact">Get in touch</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="body-contact-overlay" />
                {/* header-contact-end */}
            </div>
        </header>
